import os
from Wiki_W.modules.sql.night_mode_sql import (
    add_nightmode,
    rmnightmode,
    get_all_chat_id,
    is_nightmode_indb,
...
from Wiki_W import telethn as tbot, OWNER_ID
